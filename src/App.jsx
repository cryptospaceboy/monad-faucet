  ...
  const claimFaucet = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        checkCooldown(address); // check cooldown in background
      } else {
        if (data.error?.includes("age")) {
          ...
          setStatus("❌ You must wait for the cooldown before claiming again.");
        } else {
          setStatus("❌ Claim failed. Please try again later.");
        }
      }
    } catch {
